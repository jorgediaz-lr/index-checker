...
public class IndexWrapperLuceneReflection extends IndexWrapper{
	...
	protected static Object getIndexSearcher(Company company)
		...
		return PortalClassInvoker.invoke(false,getIndexSearcher, company.getCompanyId());
	}

	public IndexWrapperLuceneReflection(PrintWriter out, Company company) {

		this.out = out;

		Object indexSearcher;
		try {
			indexSearcher = IndexWrapperLuceneReflection.getIndexSearcher(company);
		} catch (Exception e) {
			e.printStackTrace();
