...
public class ModelUtil {
	...
	public static Class<?> getJavaClass(Map<String, Class<?>> javaClassesCache, ClassLoader classloader, String className) throws ClassNotFoundException {
	...
	public static Object getLiferayModelImplField(Class<?> classLiferayModelImpl, String liferayModelImplField) {
		Object data = null;
		try {
			Field field = classLiferayModelImpl.getDeclaredField(liferayModelImplField);
			data = field.get(null);
		}
		catch(Exception e) {
			throw new RuntimeException("Error accessing to " + classLiferayModelImpl.getCanonicalName() + "#" + liferayModelImplField, e);
		}
		return data;
	}
	...
	public static String getLiferayModelImpl(Class<? extends ClassedModel> clazz) {
		...
		String name = pkg.getName() + ".impl." + clazz.getSimpleName() + "ModelImpl";

		_log.debug("ModelImpl of " + clazz.getCanonicalName() + ": " + name);
	...
	public static String getLiferayLocalServiceUtil(Class<? extends ClassedModel> clazz) {
		...
		String name = packageName + ".service." + clazz.getSimpleName() + "LocalServiceUtil";

		_log.debug("LocalServiceUtil of " + clazz.getCanonicalName() + ": " + name);
